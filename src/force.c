...
void force(mdsys_t *sys)
{
    ...
    /*Newton's 3rd law has been implimented here which allows us only to calculate
    the upper triangular matrix and know the value of the lower triangular part of the matrix*/
